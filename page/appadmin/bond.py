...
class PageBond(PageBase):
	...
	def input_recordInfo(self):
		logging.info(f'输入Record')
		self.findElement(self.recordInfo).send_keys('recordInfo from webAutoTest')
	...
	def successFlag(self):
		return self.isEleExists(self.flag,timeout=30)
